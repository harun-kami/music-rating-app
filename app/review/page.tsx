...
function ReviewContent() {
  ...
  // 1. アーティストページ等のリンクからIDを検知して自動読み込み
  useEffect(() => {
        ...
        {!selectedAlbum ? (
          ...
          <div className="pt-10">
            ...
            <form onSubmit={handleSearch} className="relative mb-12">
              ...
              />
              <button className="absolute right-4 top-1/2 -translate-y-1/2 bg-orange-500 text-black px-8 py-3 rounded-2xl font-black italic active:scale-95 transition-all">SEARCH</button>
            </form>
              ...
              <div className="flex overflow-x-auto gap-6 pb-12 scrollbar-hide snap-x">
                {results.map((album) => (
                  ...
                  >
                    ...
                    <p className="text-gray-600 text-[8px] font-bold uppercase tracking-[0.2em]">{album.artistName}</p>
                  </div>
                ))}
              </div>
            )}
          ...
          /* --- RATING VIEW (YOUR ORIGINAL STYLE) --- */
          <>
